...
export const activityAdminColumnPresets: TableColumnPreset<ManageableActivityItem>[] =
  [
    ...
    // =============== 报名时间 ===============
    { key: "signStartTime", title: "报名开始", width: 180 },
    { key: "signEndTime", title: "报名截止", width: 180 },

    // =============== 活动时间 ===============
    { key: "activityStime", title: "活动开始", width: 180 },
    { key: "activityEtime", title: "活动结束", width: 180 },

    // =============== 人数统计（分列） ===============
    { key: "fullNum", title: "人数上限", width: 120 },
